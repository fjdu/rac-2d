...
This assumes the `raytracing_configure` section of the previous configuration
file is already what you want, otherwise you also need to modify that section.
